...
#define LIST_HEAD(name) \
    struct cbb_list_head name = LIST_HEAD_INIT(name)
#endif
...
#define cbb_list_for_each_tail(pos, head) \
    for (pos = (head)->prev; ((pos != (head)) && (pos != NULL)); \
        pos = (pos)->prev)

#define cbb_list_for_each_safe_tail(pos, n, head) \
